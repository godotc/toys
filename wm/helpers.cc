...
struct wl_shm_pool *hello_create_memory_pool(int file)
{
    ...
    data = (pool_data *)malloc(sizeof(struct pool_data));
    ...
    data->memory = (pixel *)mmap(0, data->capacity,
...
void hello_free_memory_pool(struct wl_shm_pool *pool)
{
    ...
    data = (struct pool_data *)wl_shm_pool_get_user_data(pool);
                                      ...
                                      unsigned width, unsigned height)
{
    ...
    pool_data = (struct pool_data *)wl_shm_pool_get_user_data(pool);
...
void hello_free_surface(struct wl_shell_surface *shell_surface)
{
    ...
    surface = (wl_surface *)wl_shell_surface_get_user_data(shell_surface);
    ...
    void (*callback)(uint32_t))
{
    ...
    surface = (wl_surface *)wl_shell_surface_get_user_data(shell_surface);
    wl_surface_set_user_data(surface, (void *)callback);
}
                                ...
                                int32_t hot_spot_x, int32_t hot_spot_y)
{
    ...
    data = (pointer_data *)malloc(sizeof(struct pointer_data));
...
void hello_free_cursor(void)
{
    ...
    data = (pointer_data *)wl_pointer_get_user_data(pointer);
                          ...
                          wl_fixed_t surface_x, wl_fixed_t surface_y)
{
    ...
    pointer_data                 = (struct pointer_data *)wl_pointer_get_user_data(wl_pointer);
                           ...
                           uint32_t time, uint32_t button, uint32_t state)
{
    ...
    pointer_data = (struct pointer_data *)wl_pointer_get_user_data(wl_pointer);
    callback     = (void (*)(uint32_t))wl_surface_get_user_data(
