...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.SysStatus = field.NewInt16(tableName, "sys_status")
	_user.SysCreated = field.NewInt32(tableName, "sys_created")
	_user.SysUpdated = field.NewInt32(tableName, "sys_updated")
