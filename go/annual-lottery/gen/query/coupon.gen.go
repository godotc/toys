...
func newCoupon(db *gorm.DB, opts ...gen.DOOption) coupon {
	...
	_coupon.GiftID = field.NewInt32(tableName, "gift_id")
	_coupon.Code = field.NewString(tableName, "code")
	_coupon.SysStatus = field.NewInt16(tableName, "sys_status")
	_coupon.SysCreated = field.NewInt32(tableName, "sys_created")
	_coupon.SysUpdated = field.NewInt32(tableName, "sys_updated")
...
func (c *coupon) updateTableName(table string) *coupon {
	...
	c.GiftID = field.NewInt32(table, "gift_id")
	c.Code = field.NewString(table, "code")
	c.SysStatus = field.NewInt16(table, "sys_status")
	c.SysCreated = field.NewInt32(table, "sys_created")
	c.SysUpdated = field.NewInt32(table, "sys_updated")
...
func (c *coupon) fillFieldMap() {
	...
	c.fieldMap["id"] = c.ID
	c.fieldMap["gift_id"] = c.GiftID
	c.fieldMap["code"] = c.Code
	c.fieldMap["sys_status"] = c.SysStatus
	c.fieldMap["sys_created"] = c.SysCreated
	c.fieldMap["sys_updated"] = c.SysUpdated
}
