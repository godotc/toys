...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.Coupon.UnderlyingDB().Statement.Context,
		qCtx.Gift.UnderlyingDB().Statement.Context,
		qCtx.IPBlacklist.UnderlyingDB().Statement.Context,
		qCtx.LotteryRecord.UnderlyingDB().Statement.Context,
		qCtx.User.UnderlyingDB().Statement.Context,
		qCtx.UserBlacklist.UnderlyingDB().Statement.Context,
		qCtx.UserParticipation.UnderlyingDB().Statement.Context,
	} {
